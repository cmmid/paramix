...
```{r, ifrfig, cache = TRUE, out.width = "100%"}
plot_dt <- density_dt[, {
...
# with the exception of wm_f, these are independent of density, so we can narrow

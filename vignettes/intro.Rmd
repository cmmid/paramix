...
Fortunately, the correct values are not *difficult* to calculate, but they are *tedious* to calculate. The `YLLr` package automates this process, so that you can focus on the analysis rather than the bookkeeping.

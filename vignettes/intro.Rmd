...
```{r, ifrfig, echo = FALSE, cache = TRUE, out.width = "100%"}
...
model_deaths_dt |> dcast.data.table(model_from ~ name, value.var = "deaths")
```

For these approaches, we get the following distribution of deaths by age category:

```{r alembicsetup, echo = FALSE, cache = TRUE, out.width = "100%", fig.height = 5}
...
```{r, figlex, cache=T, out.width="100%", fig.height=3}
data("mxB1")
